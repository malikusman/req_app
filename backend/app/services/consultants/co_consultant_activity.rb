...
module Consultants
  class CoConsultantActivity
    ...
    def call
      chat_count = ConsultantChatMessage.where(
        company_id: @company_id,
        sender_consultant_user_id: @review.consultant_user_id
      ).count
      ...
      last_chat = ConsultantChatMessage.where(
        company_id: @company_id,
        sender_consultant_user_id: @review.consultant_user_id
      ).maximum(:created_at)
