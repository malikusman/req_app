...
module Reviewers
  class QuestionnaireSync
    ...
    def self.call(reviewer:, answers:)
      new(reviewer: reviewer, answers: answers).call
    end

    def initialize(reviewer:, answers:)
      @reviewer = reviewer
    ...
    def call
      ...
      ActiveRecord::Base.transaction do
        @reviewer.update!(attrs.compact) if attrs.compact.present?
