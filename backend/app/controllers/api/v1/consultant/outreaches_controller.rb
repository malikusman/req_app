      ...
      class OutreachesController < BaseController
        def index
          ...
          outreaches = ::ConsultantOutreach
            ...
            .includes(:consultant_outreach_replies, :consultant_user, :employee)
        ...
        def outreach_json(o)
          {
            ...
            replies: o.consultant_outreach_replies.sort_by(&:received_at).map { |r| reply_json(r) },
