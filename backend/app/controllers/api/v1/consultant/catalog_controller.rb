  ...
  module V1
    module Consultant
      class CatalogController < BaseController
        ...
        # company — the pool a consultant can add from.
        def available
          company = find_assigned_company!
        ...
        # Consultant attaches a catalog product to this company's recommended list.
        def add_product
          company = find_assigned_company!
          ...
          match.assign_attributes(
            ...
            why_it_fits: params[:why_it_fits].presence || "Added by consultant as a relevant fit for this company.",
            added_by_consultant: current_consultant_user,
        ...
        def match_json(m)
          entry = m.solution_catalog_entry
          {
            ...
            added_by_consultant_id: m.added_by_consultant_id,
            added_by_consultant_name: m.added_by_consultant&.name,
