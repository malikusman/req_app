    ...
    module Consultant
      class CompaniesController < BaseController
        ...
        def show
          ...
          my_review = latest_report && ReportReview.find_by(report: latest_report, consultant_user: current_consultant_user)
          ...
          render json: {
            ...
            ).merge(Companies::AgentContext.consultant_profile_json(company))
          }
        end
