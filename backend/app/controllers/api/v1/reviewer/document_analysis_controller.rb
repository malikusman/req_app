    ...
    module Reviewer
      class DocumentAnalysisController < BaseController
        ...
        def show
          ...
          unless current_reviewer_user.reviewer_assignments.active.exists?(company_id: @company.id)
          ...
          questions = @company.company_clarification_questions.for_reviewer.order(created_at: :desc).limit(100)
        ...
        def dismiss_question
          ...
          question.update!(
            ...
            dismissed_by_reviewer_user: current_reviewer_user,
